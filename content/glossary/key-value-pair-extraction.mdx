...
description: "Key-value pair extraction locates labeled fields in documents — invoice numbers, dates, names — and outputs them as structured, downstream-ready data."
