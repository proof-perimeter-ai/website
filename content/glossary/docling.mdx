...
description: "Docling is an open-source document parsing toolkit that converts PDFs and office files into structured formats — layout, tables, reading order."
