...
description: "Data normalization converts extracted document values into canonical formats — dates, amounts, names, codes — so downstream systems compare and compute correctly."
