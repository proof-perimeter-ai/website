...
description: "You Only Look Once (YOLO) is a fast single-pass object detection architecture widely used for document element detection — stamps, signatures, tables, checkboxes."
