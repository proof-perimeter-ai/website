...
description: "Table extraction from documents recovers structured grids from tables — detection, cell structure, and content — a foundational document AI capability."
