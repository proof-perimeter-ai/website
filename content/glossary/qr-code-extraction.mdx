...
description: "QR code extraction detects and decodes QR codes in documents — structured data recovered reliably via built-in Reed-Solomon error correction."
