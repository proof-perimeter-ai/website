...
description: "Document splitting AI detects boundaries between documents in combined files — separating scanned bundles into processable units for extraction."
