...
description: "Document embeddings encode text and pages as vectors capturing meaning — powering semantic search, similarity matching, and RAG retrieval accuracy."
category: "RAG & Search"
