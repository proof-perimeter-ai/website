...
description: "Zonal OCR restricts recognition to predefined regions on a fixed layout — fast and precise where documents genuinely don't vary, a template-era technique."
