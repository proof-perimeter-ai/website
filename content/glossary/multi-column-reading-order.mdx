...
description: "Multi-column reading order determines the correct sequence through columnar layouts, headings, and sidebars — the ordering half of multi-column parsing."
