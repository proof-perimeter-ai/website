...
A [demo call](/book-demo) is a more direct way to get these answers than a vendor's compliance FAQ page — bring a real KYC packet or claims file and ask, specifically, where the extraction runs.
