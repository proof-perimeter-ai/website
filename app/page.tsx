...
const complianceNote =
  "AI governance and controls offered with Enterprise plan.";
...
const softwareApplicationJsonLd = {
  ...
  operatingSystem: "Web",
  featureList: capabilities.map((cap) => cap.name),
  offers: [
    {
      "@type": "Offer",
      ...
      price: "0",
      priceCurrency: "USD",
      description: comparisonRows[0][1],
    },
    {
      "@type": "Offer",
      name: "Enterprise License",
      description: comparisonRows[0][2],
    },
  ],
};
  ...
  return (
    <>
      ...
      <main className="flex-1">
        ...
        <section className="border-t border-line py-22">
          <div className="mx-auto max-w-[1120px] px-7 text-center">
            ...
            <h2 className="mx-auto mt-4.5 max-w-[22ch] text-[clamp(28px,3.6vw,38px)] font-bold tracking-[-0.022em] text-ink">
              Loved for our accuracy, speed, and ease of use
            </h2>
          ...
          <div className="mx-auto max-w-[1120px] px-7">
            ...
            <div className="mt-10.5 border-t border-line">
              {personas.map((persona) => (
                ...
                >
                  <div className="text-[17.5px] font-semibold text-ink px-4">{persona.title}</div>
                  <p className="m-0 text-[14.7px] text-ink-2 px-4">{persona.description}</p>
                </div>
              ))}
            </div>
          </div>
        ...
        {/* Path comparison */}
        <section id="choose-your-path" className="border-t border-line py-22">
          <div className="mx-auto max-w-[1120px] px-7">
        ...
        <section id="regulators" className="border-t border-line py-22">
          <div className="mx-auto max-w-[1120px] px-7">
            <div className="grid grid-cols-1 gap-10 md:grid-cols-2 md:items-center">
              <div>
                <Eyebrow>Enterprise compliance</Eyebrow>
                <h2 className="mt-4.5 max-w-[22ch] text-[clamp(28px,3.6vw,38px)] font-bold tracking-[-0.022em] text-ink">
                  Top-grade compliance ships with Enterprise.
                </h2>
                <p className="mt-4 max-w-[46ch] text-[15px] text-ink-2">{complianceNote}</p>
                ...
                <Link href="/enterprise" className="mt-2 inline-block text-[14.5px] font-semibold text-signal hover:text-signal-deep">
                  See Enterprise Plan →
                </Link>
              </div>
